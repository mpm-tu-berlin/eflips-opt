...
async def deadhead_cost(
    ...
    :param client: An openrouteservice client
    ...
    :return: A dictionary with the distance and duration between point_start and point_end
    """
...
async def calculate_deadhead_costs(
    ...
    """
    Calculate the deadhead costs for a dataframe of rotations
    :param df: input dataframe representing the rotation information. It is generated by get_rotation()
    :param client: a openrouteservice client
    :return: A list of python Coroutines for asynchronous computation of deadhead costs
    """
...
def get_depot_rot_assign(session: Session, scenario_id: int) -> pd.DataFrame:
    ...
    :param scenario_id: an integer representing the scenario id
    :return: a :class:'pandas.DataFrame' object with the following columns:
    - rotation_id: The id of the rotation
    - orig_depot_station: The id of the assigned depot-station
    """
    data = []
...
def get_rotation_vehicle_assign(session: Session, scenario_id: int) -> pd.DataFrame:
    ...
    - rotation_id: The id of the rotation
    - vehicle_type_id: The id of the vehicle type
    - assignment: The assignment of the vehicle type to the rotation with 1 representing the vehicle type is assigned to the corresponding rotation and 0 vice versa
    """
...
def get_occupancy(
    ...
    :return: a :class:'pandas.DataFrame' object with the occupancy data, which includes the following columns:
     -rotation_id: The id of the rotation
     - time slots in the unit of seconds after the simulation start
     - The entries indicating the occupancy, with 1 meaning this time slot is occupied and 0 vice versa.
